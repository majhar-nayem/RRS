                    ...
                    <div class="w-full">
                        <form action="{{ url('/user/post') }}" method="POST">
                            ...
                            <div class="textarea px-2 mt-6">
                                <textarea name="comment" class="w-full h-15 focus:outline-none resize-none" placeholder="What's your experience?" rows="4" required></textarea>
                            </div>
                                            ...
                                            <div class="inner flex">
                                                ...
                                                <div class="inline-block w-full">
                                                    ...
                                                    <div class="inline-flex ficon-wrapper like text-gray-600">
                                                        ...
                                                        <span class="px-1 inline-block ficon-text font-normal"> {{ $post->like }} </span>
                                                    </div>
                                                    </a>
                                                </div>
