...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Restaturent Review System</title>
        ...
        <div class="flex items-center">
          ...
          <div class="md:block flex flex-col">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Restaturent</a>
            ...
            <input class="rounded mx-4" type="text" placeholder="Search For Restaturent">
            </form>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="ml-3 relative">
              <div>
                <button class="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu" aria-haspopup="false">
  ...
  <main>
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      ...
      <div class="px-4 py-6 sm:px-0">
        <div class="border border-gray-200 rounded-lg h-screen"></div>
      </div>
      <!-- /End replace -->
    </div>
  </main>
    ...
    <footer>
    <span class="justify-center">Restaturent Management System</span>
    </footer>
    </body>
</html>
