                    ...
                    <div class="side-navigation my-2">
                        ...
                        <ul class="side-navigation-list">
                            ...
                            <li class="side-navigation-list-item">
                                <a href="{{ route('home') }}" class="active clearfix w-auto p-2 px-4 mt-2 transition-3 inline-block rounded-full">
                            ...
                            <!-- side navigation list item start -->
                            <li class="side-navigation-list-item">
                                <a href="{{ url('user/restaurants') }}" class="clearfix w-auto p-2 px-4 mt-2 transition-3 inline-block rounded-full">
                                    <i class="icon float-left">
                                    ...
                                    <span class="name float-left pl-5 font-bold text-xl">
                                        Restaurants
                                    </span>
                                </a>
                            </li>
